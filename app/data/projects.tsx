export const projects = [
  ...
  },
  {
    name: "Web Split Bill",
    description:
      "Web Split Bill is an intuitive web application designed to help users easily split expenses within a group. It allows users to add and manage individual contributions, calculate totals, and divide costs fairly among participants. Built with ReactJS, the app provides a seamless and user-friendly experience for tracking and settling group expenses.",
    image: "/assets/images/splitt-bill.png",
    stack: ["ReactJS"],
    github: "https://github.com/zyreejago/split-bill",
  },
  {
    name: "GoCheck",
    description:
