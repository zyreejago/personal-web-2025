...
const workExperiences: WorkExperience[] = [
  {
    ...
    description:
      "As a freelancer, I provide professional web and mobile development services, helping clients complete their projects efficiently and effectively. I focus on delivering high-quality results that meet client expectations, with attention to detail and a commitment to timely completion. My work consistently receives positive feedback, reflecting my dedication to client satisfaction and excellence in every project.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "I worked as a freelancer. The task was to refine the interface using Laravel framework along with CSS styling to enhance the web applications appearance. Given the limited timeframe, I worked from night until morning.",
    achievements: [
...
const organizationExperiences: OrganizationExperience[] = [
  {
    ...
    description:
      "As the coordinator for the Mobile Legends event at Integer #6, my responsibilities include scheduling with team members, developing a guidebook, managing stage setups, and ensuring smooth event execution for 32 participants from high schools and universities in Bali.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "As the coordinator for the PUBG Mobile event at Integer #5, my responsibilities include scheduling with team members, creating a guidebook, managing stage mockups, and facilitating the event exclusively for TI Undiksha students to nurture their gaming talents.",
    achievements: [
      "Displaying strong leadership by guiding the team effectively to work collaboratively.",
      "Collaborating in teamwork to ensure a smooth event by coordinating well among committee members.",
      "Supporting the successful execution of the event with structured and professional organization.",
  ...
  },
  {
    ...
    description:
      "As a logistics member for the Music Event at Integer #5, my role involves assisting in managing and displaying the artist requirements, ensuring smooth execution of logistical operations for the event.",
    achievements: [
...
export default function Experience() {
  ...
  const experiences: Experience[] = showOrganization
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.h2
          className="text-4xl md:text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600"
                ...
                <div className="w-full md:w-3/4 bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <AnimatePresence>
                    {expandedIndex === index && (
                      ...
                      >
                        <h5 className="font-semibold text-purple-300 mt-2 mb-1">
                          Key Achievements:
                        </h5>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(exp.type === "work" ? exp.stack : exp.skills).map(
                            (tech, i) => (
                              <motion.span
                                key={i}
